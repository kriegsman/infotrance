...
function moveSlider(evnt)
{
	...
	if (carpemouseover) { // Only if slider is dragged
		...
		//MEK
		if ( typeof( carpedisplay != "undefined") ) {
			if( typeof( slidercallback ) == "function") {
				slidercallback( carpedisplay );
			}
		}
		//MEK end
...
//MEK
function setSliderPosFromValue(display,slider) 
{
	var v = (display.value) ? display.value : 0 // Find last display value.
...
function sliderMouseUp()
{
	if (carpemouseover) {
//MEK
		setSliderPosFromValue( carpedisplay, carpeslider);
//MEK
